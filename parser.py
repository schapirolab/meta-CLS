...
def get_parser():
    ...
    parser.add_argument('--hsplit_idx', type=int, default=-2,
                        help='which layer to split')
    parser.add_argument('--xav_init', default=False , action='store_true',
                        help='Use xavier initialization')
    parser.add_argument('--two_pathway', default=False, action='store_true',
                        help='feedforward architecture with two pathways')
    parser.add_argument('--lesion_large', default=False, action='store_true',
                        help='lesion the larger pathway')
    parser.add_argument('--lesion_small', default=False, action='store_true',
                        help='lesion the smaller pathway')
    ...
    parser.add_argument('--small_test', default=False, action='store_true',
                        help='use fewer samples for testing.')


    parser.add_argument('--add_item_labels', default=0.0,
                        help='add additional label for each item')
    parser.add_argument('--num_of_item_labels', type=int, default=0,
                        help='specify the number of item labels')
    parser.add_argument('--item_option', type=str, default="no_label",
                        help='specify how to assign item labels',
                        choices = ["no_label", "per_item"])


    # Sparsity parameters
    parser.add_argument('--normalize_hidden', default=False, action='store_true',
                        help='normalize hidden activations')
    parser.add_argument('--remove_bias', default=False, action='store_true',
                        help='remove bias')
    parser.add_argument('--learn_inhibition_multiplier', default=False, action='store_true',
                        help='learn inhibition multiplier')
    parser.add_argument('--multiplier_lr', type=float, default=0.15,
                        help='learning rate for inhibition mulitplier')
    ...
    parser.add_argument('--learn_layer_lr', default=False, action='store_true',
                        help='model should learn per-layer learning rate')
    parser.add_argument('--no_relu_lr',  default=False, action='store_true',
                        help='no relu for learning rates')
    ...
    # Sparse-MAML parameters
    parser.add_argument('--sparse_MAML', default=0.0,
                        help='implement sparse-MAML')
